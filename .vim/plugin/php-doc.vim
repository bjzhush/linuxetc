...
let g:pdv_cfg_Author = "Shuai Zhu <bjzhush@gmail.com>"
let g:pdv_cfg_Copyright = "{@link http://www.php.net/license/3_1.txt}"
let g:pdv_cfg_License = "PHP Version 3.1 {@link http://www.php.net/license/3_1.txt}"
